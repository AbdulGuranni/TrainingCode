...
public interface IDoctorService {
    ...
    List<Doctor> getSpeciality(String speciality) throws DoctorNotFoundException;
    ...
    List<Doctor> getSpecialityAndNameContains(String speciality,String doctorName) throws DoctorNotFoundException;
